$(document).ready(function () { //jQeury to detect state of readiness to safely manipulate page
  ...
  var bread = document.getElementById("li_8"); // Bread selection
  ...
  if ($('#form_156295').length) {
    // Set initial values upon loading form
    pickup = document.getElementById("calendar_4").children['element_4_datepick'].value; // Pickup date

    //weekday.value = String(dow);
    //weekday.click();
    setDay(pickup);
      ...
      $(document).change(function () {
        ...
        pickup = document.getElementById("calendar_4").children['element_4_datepick'].value;
        //weekday.value = String(dow);
        //weekday.click();
